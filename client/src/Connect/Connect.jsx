...
function Connect() {
    return(
        <>
        <Navbar/>
        <div className="hidden md:flex container mx-auto space-x-3 pt-20">
  </div>
            <div>
             <div className="container flex justify-center mx-auto pt-16">
                 <div>
                     <h1 className="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">Connect with like minded people around the world</h1>
                 </div>
             </div>
             <div className="w-full bg-gray-100 px-10 pt-10">
            <div className="container mx-auto">
            <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around gap-4">
            {
            Profiles.map(profile => {
            return(
                <div className={styles.card}>
              <div className={styles.img} >
                <img src={profile.profileImageUrl}></img>
              </div>
              <span>{profile.fullName}</span>
              <p className={styles.info}>{profile.currentJob}</p>
              ...
              <button onClick={()=>{handleConnect(profile.url)}} className="px-0">Connect</button>
</div>
            )
            })
        }
