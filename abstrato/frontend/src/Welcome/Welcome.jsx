    ...
    <>
        ...
        <div className={styles.div}>
          <div className={styles.overlap}>
            <div className={styles.text}>
              ...
              <p className={styles.p}>
                Your dream job is within reach. Let us show you the path to get
                there.
              </p>
              <img
                className={styles["unlock-your-dream"]}
          ...
          <div className={styles.navigation}>
            ...
            <div className={styles.navbar}>
              <Link
                to="/Signup"
                className="hidden md:flex text-md text-gray-500  hover:text-black pb-2 px-3 items-center h-5/6"
              >
                Jobs
              </Link>
              <Link
                to="/Signup"
                className="hidden md:flex text-md text-gray-500  border-transparent hover:text-black pb-2 px-3 items-center h-5/6 "
              >
                Courses
              </Link>
              <Link
          ...
          <img
            className={styles["undraw-career"]}
            alt="Undraw career"
            src={career_progress}
          />
        </div>
          ...
          <div className={styles["overlap-group"]}>
            <p className={styles["learn-with-your"]}>
              ...
              <span className={styles["text-wrapper"]}>
                , Connect with new people. Grow with the{" "}
              </span>
              <span className={styles["text-wrapper-2"]}>Community.</span>
              <span className={styles["text-wrapper"]}>&nbsp;</span>
            </p>
            <img
              className={styles["community-cropped"]}
              alt="Community cropped"
              src={community}
            />
          </div>
        </div>
      ...
      <div className={styles["body2-page"]}>
        <div className={styles["overlap-group-wrapper"]}>
          <div className={styles["overlap-group"]}>
            ...
            />
            <img
              className={styles["undraw-progress"]}
              alt="Undraw progress"
              src={body2}
            />
          </div>
      ...
      <div className={styles["body3-page"]}>
        <div className={styles["overlap-group-wrapper"]}>
          <div className={styles["overlap-group"]}>
            <img
              className={styles["undraw-organize"]}
              alt="Undraw organize"
              src={resume}
            />
            <p className={styles["got-the-skills-build"]}>
              ...
              <span className={styles["text-wrapper"]}>
                {" "}
                that gets you selected, by using our templates. It’s{" "}
              </span>
