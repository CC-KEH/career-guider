          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="/" onClick={handleRefresh} className="hover:underline">Abstrato</a>
                      </li>
                      <li>
                          <a href="/" onClick={handleRefresh} className="hover:underline"></a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/CC-KEH" className="hover:underline ">Github</a>
                      </li>
                      <li>
                          <a href="/" onClick={handleRefresh} className="hover:underline">Twitter</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="index.html" onClick={handleRefresh} className="hover:underline">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="index.html" onClick={handleRefresh} className="hover:underline">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
